type mundos = "habitado" | "habitável" | "inabitável" | "inexplorado"
let mundo: mundos
const totalPlanets: {nome: string, coordenadas: number[], satelites: String[], situacao: mundos | null}[] = []

function planets(planet:{nome: string, coordenadas: number[], satelites: String[], situacao: mundos | null}) {
    ...
    const planeta = {
        ...
        situacao: planet.situacao as mundos
    }
...
function createPlanet(){
    ...
    if (confirmation) {
        ...
        planets({ nome, coordenadas: [coordenadas], satelites: [], situacao: situacao as mundos });
    }
}


function updateSituation(nome:string){
    ...
    if(findPlanet){
        ...
        switch(novaSituacao){
            case "habitado":
                ...
                case "inabitável":
                case "inexplorado":
                    findPlanet.situacao = novaSituacao as mundos
...
function addSateliteNoPlaneta(nome:string){
    const findPlanet = totalPlanets.find(planeta => planeta.nome === nome)
...
function removeSatelite(nome:string){
    const findPlanet = totalPlanets.find(planeta => planeta.nome === nome)
    if(findPlanet){
